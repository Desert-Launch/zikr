...
class WSurahFilterBar extends StatelessWidget {
  const WSurahFilterBar({super.key, required this.cubit, required this.state, required this.green});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        boxShadow: [BoxShadow(color: Color(0x12000000), blurRadius: 5, offset: Offset(0, 2))],
      ),
      child: Row(
        children: [
          WSurahFilterButton(
