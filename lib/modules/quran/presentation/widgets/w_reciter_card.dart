...
class WReciterCard extends StatelessWidget {
  const WReciterCard({required this.reciter, required this.stats, required this.onTap, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final parts = <String>[
      ...
      if (s != null && s.totalBytes > 0) '${s.megabytes.toStringAsFixed(0)} ${'quran_downloads_mb'.tr()}',
    ];
            ...
            child: Row(
              children: [
                CircleAvatar(
                  ...
                  child: Icon(Icons.record_voice_over_rounded, color: brand.primary, size: 24.r),
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontSize: 15.sp, fontWeight: FontWeight.w700, color: brand.onSurface),
                      ),
                      SizedBox(height: 2.h),
                      Text(
                        reciter.name,
                      ...
                      Text(
                        parts.join(' · '),
                        style: TextStyle(fontSize: 11.sp, color: brand.primary, fontWeight: FontWeight.w600),
                      ),
                    ],
                  ),
                ),
