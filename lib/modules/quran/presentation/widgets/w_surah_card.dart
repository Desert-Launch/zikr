...
class WSurahCard extends StatelessWidget {
  const WSurahCard({super.key, required this.surah, required this.green, required this.gold, required this.onTap});
        ...
        child: Row(
          children: [
            ...
            Container(
              ...
              child: Text(
                surah.isMakki ? 'surah_list_meccan'.tr() : 'surah_list_medinan'.tr(),
                style: AppTextStyles.ink12W400.copyWith(color: typeColor, fontSize: 10.sp, height: 1.2),
              ),
            ),
          ],
        ),
