            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.bookmark_rounded, color: accent, size: 24.r),
                ),
                SizedBox(width: 12.w),
                Expanded(
                  child: Column(
                      ...
                      Wrap(
                        ...
                        children: [
                          _Chip(
                            ...
                            label: '${'quran_ayah_label'.tr()} ${bookmark.ayah}',
                          ),
                          if (surah != null)
                            _Chip(
                              icon: surah!.isMakki
                ...
                IconButton(
                  icon: Icon(Icons.delete_outline_rounded, color: context.brand.muted),
                  onPressed: onDelete,
                ),
              ],
            ),
