  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CBAuth, SAuth>(
      ...
      builder: (_, state) {
        ...
        return Container(
          padding: EdgeInsets.symmetric(horizontal: 30.w, vertical: isTab ? 14 : 18.h),
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.cairo(
                        ...
                        fontSize: isTab ? 19 : 16.sp,
                        fontWeight: FontWeight.w500,
                        height: 1.15,
                      ),
                    ),
                    SizedBox(height: isTab ? 4 : 5.h),
                    Text(
                      user?.email ?? 'user@example.com',
                      style: GoogleFonts.cairo(
                        fontSize: isTab ? 13.5 : 11.sp,
                        color: const Color(0xFF7C7C7C),
                        height: 1,
                      ),
                    ),
                    SizedBox(height: isTab ? 6 : 7.h),
                    InkWell(
