  ...
  void routes(RouteManager r) {
    ...
    r.child(
      ...
      child: (_) {
        ...
        return SNAzkarCategory(categoryId: categoryId);
      },
    );
    r.child(
      AzkarRoutes.player,
      child: (_) {
        final categoryId = r.args.queryParams['category'] ?? 'morning';
        final itemIndex = int.tryParse(r.args.queryParams['item'] ?? '') ?? 0;
        return SNAzkarPlayer(categoryId: categoryId, itemIndex: itemIndex);
      },
    );
