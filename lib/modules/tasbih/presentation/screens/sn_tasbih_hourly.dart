...
class SNTasbihHourly extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider.value(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text('tasbih_hourly_title'.tr(),
              ...
              children: [
                Card(
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        title: Text('tasbih_hourly_enable'.tr(),
                            style: TextStyle(
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w700,
                            )),
                        subtitle: Text('tasbih_hourly_hint'.tr(),
                            style: TextStyle(fontSize: 11.sp)),
                        value: state.hourlyEnabled,
                        onChanged: (v) async {
                          if (v) {
                            final granted = await Modular
                      ...
                      Divider(height: 1.h),
                      SwitchListTile(
                        title: Text('tasbih_vibrate'.tr(),
                            style: TextStyle(
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w700,
                            )),
                        subtitle: Text('tasbih_vibrate_hint'.tr(),
                            style: TextStyle(fontSize: 11.sp)),
                        value: state.vibrate,
